...
root = Tk()
root.title("StARS Password Gate")

# Methods for the Widgets

def changecol1():
    lab2.config(image=img2)
...
img1 = PhotoImage(file="C:/Users/Abdullah.H/Desktop/python/Gate/closed gate.png")
img2 = PhotoImage(file="C:/Users/Abdullah.H/Desktop/python/Gate/open gate.png")
img3 = PhotoImage(file="C:/Users/Abdullah.H/Desktop/python/Gate/sign in 2.png")
img4 = PhotoImage(file="C:/Users/Abdullah.H/Desktop/python/StARS Logo Transparent1.png")

#Labels

lab1 = Label(mainframe, text="StARS Wifi Gate")
lab1.grid(row = 1, column =4, sticky='')

lab2 = Label (mainframe, image=img4)
lab2.grid(row = 2, column =4, sticky='')

lab3 = Label(mainframe, image=img1)
...
choice1 = "Essaf"
choice2 = "Maadi"
popupMenu = OptionMenu(mainframe, tkvar, choice1, choice2)
...
def change_dropdown(*args):
    ...
    # link function to change dropdown
            ...
            Label(mainframe, text="Choose a Network").grid(row = 6, column = 4, sticky='')
...
Label(mainframe, text="Choose a Site").grid(row = 4, column = 4,sticky='')
...
butt = Button(mainframe, image=img3, text="Sign in")
